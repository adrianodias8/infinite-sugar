...
const scope = vm.createContext({
  ...
  stepSimulation:()=>steps++, syncGeoms:()=>{}, model:{}, data:{}, loom:{active:false}, syncStimUI:()=>{}, flight:{state:'ground',count:0,escape:0,walk:{count:0}}, stepFollow:()=>{}, world:{enabled:true,day:1,levels:{sweet:0,sweetLeg:0,object:0},loomers:[]}, groom:{active:false},
});
