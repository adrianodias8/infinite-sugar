...
const scope = vm.createContext({
  ...
  neuralMap:{draw:()=>{}}, stepBall:()=>{}, stepGrab:()=>{}, PHYS_TIMESTEP:2e-4, PHYS_SUBSTEPS:5, BrainProxy:class {}, stepSack:()=>{}, stepSound:()=>{}, stepEyes:()=>{}, drawEyes:()=>{}, vision:{retina:null,active:false}, statusSentence:()=>'', stepRipples:()=>{}, stepLighting:()=>{}, stepLoomDisc:()=>{}, applyQuality:()=>{},
