...
for (const name of ['index.html', 'style.css', 'entry.ts', 'app.ts', 'brain.ts', 'brain-proxy.ts', 'brain-worker.ts', 'performance.ts', 'neural-map.ts', 'brain/neural-map.json', 'brain/retina.json', 'kernel/lif.wasm', 'model/scene.xml',
